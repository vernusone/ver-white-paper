...
\begin{document}
  ...
  \begin{abstract}
    \textbf{\projectname{}} was built to address systemic challenges in media we know all too well: algorithmic feeds, subscription fatigue, not to mention the ever-increasing presence of AI slop. We are building infrastructure for creator economies, enabling pay-per-piece access, fair revenue splits, on-chain ownership and proof of humanity primitives.
